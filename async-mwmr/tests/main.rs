...
impl Database for TestBTreeDb {
  ...
  async fn apply(&self, entries: OneOrMore<Entry<Self>>) -> Result<(), Self::Error> {
...
macro_rules! unittests {
  (
    ...
    //   txn_conflict_iter::<TestBTreeDb, BTreeMapManager<u64, u64>, _, $spawner>(
    //     || (),
    //     BTreeMap::default,
    //     |i| i as u64,
    //     |i| i as u64,
...
mod _tokio {
  ...
  async fn test_txn_simple() {
    txn_simple::<TestBTreeDb, BTreeMap<u64, EntryValue<u64>>, TokioSpawner>(
      (),
      BTreeMap::default,
      |i| i as u64,
      |i| i as u64,
  ...
  async fn test_txn_read_after_write() {
    txn_read_after_write::<TestBTreeDb, TokioSpawner>(
      (),
      |i| i as u64,
      |i| i as u64,
      |item| match item {
  ...
  async fn test_txn_commit_with_callback() {
    txn_commit_with_callback::<TestBTreeDb, BTreeMapManager<u64, u64>, TokioSpawner>(
      (),
      BTreeMap::default,
      |i| i as u64,
      |i| i as u64,
  ...
  async fn test_txn_versions() {
    txn_versions::<TestBTreeDb, BTreeMapManager<u64, u64>, _, _, TokioSpawner>(
      (),
      BTreeMap::default,
      |i| i as u64,
      |i| i as u64,
  ...
  async fn test_txn_write_skew() {
    txn_write_skew::<TestBTreeDb, BTreeMapManager<u64, u64>, TokioSpawner>(
      (),
      BTreeMap::default,
      |i| i as u64,
      |i| i as u64,
  ...
  async fn test_txn_iteration_edge_case() {
    txn_iteration_edge_case::<TestBTreeDb, BTreeMapManager<u64, u64>, _, _, TokioSpawner>(
      (),
      BTreeMap::default,
      |i| i as u64,
      |i| i as u64,
  ...
  async fn test_txn_iteration_edge_case2() {
    txn_iteration_edge_case2::<TestBTreeDb, BTreeMapManager<u64, u64>, _, _, TokioSpawner>(
      (),
      BTreeMap::default,
      |i| i as u64,
      |i| i as u64,
  ...
  async fn test_txn_all_versions_with_removed() {
    txn_all_versions_with_removed::<TestBTreeDb, BTreeMapManager<u64, u64>, _, TokioSpawner>(
      (),
      BTreeMap::default,
      |i| i as u64,
      |i| i as u64,
  ...
  async fn test_txn_all_versions_with_removed2() {
    txn_all_versions_with_removed2::<TestBTreeDb, BTreeMapManager<u64, u64>, _, TokioSpawner>(
      (),
      BTreeMap::default,
      |i| i as u64,
      |i| i as u64,
  ...
  async fn test_txn_conflict_get() {
    txn_conflict_get::<TestBTreeDb, BTreeMapManager<u64, u64>, TokioSpawner>(
      || (),
      BTreeMap::default,
      |i| i as u64,
      |i| i as u64,
